...
while($row = mysql_fetch_array( $result )) {
	...
	echo "<table border='1'>";
	echo "<tr> <th>No</th> <th>Author</th><th>WP POSTID</th><th>Sample Topic </th> </tr>";
	echo "<tr><td>"; 
	echo $srno ;
	echo "</td><td>"; 
	echo $postid = $row['Author'];
	echo "</td><td>"; 
	 
	 
	
	// Find the playlist id by author 
	
    $sql2 = "SELECT * FROM `wp_posts` WHERE `post_title` ='".$row['Author']."' and ID > 2260";
	// Get all the data from by topic 
