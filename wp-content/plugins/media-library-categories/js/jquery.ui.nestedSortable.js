...
(function($) {
	...
	$.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		toString: function(o) {
			...
			$(this.element).children('li').each(function () {
				sortOrder ++;
				left = _recursiveArray(this, sDepth + 1, left, sortOrder);
			});

			return ret;

			function _recursiveArray(item, depth, left, sortOrder) {
				...
				if ($(item).children(o.listType).children('li').length > 0) {
					...
					$(item).children(o.listType).children('li').each(function () {
						subSort++;
						right = _recursiveArray($(this), depth, right, subSort);
					});
					depth --;
				}
