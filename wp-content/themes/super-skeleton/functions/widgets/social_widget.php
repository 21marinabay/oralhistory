...
// 5. This builds the form for the actual widget menu. 
        ...
        <p><small>Enter a URL in each field. Only filled in fields will show up.</small></p>
            ...
            <p><label for="<?php echo $this->get_field_id('delicious'); ?>"><?php _e('Delicious:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('deviantart'); ?>"><?php _e('DeviantArt:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e('Flickr:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('LinkedIn:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('myspace'); ?>"><?php _e('MySpace:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('netvibes'); ?>"><?php _e('NetVibes:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('reddit'); ?>"><?php _e('Reddit:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('rss'); ?>"><?php _e('RSS:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('skype'); ?>"><?php _e('Skype:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('tumblr'); ?>"><?php _e('Tumblr:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('stumbleupon'); ?>"><?php _e('StumbleUpon:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('vimeo'); ?>"><?php _e('Vimeo:'); ?> 
            ...
            <p><label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('YouTube:'); ?> 
